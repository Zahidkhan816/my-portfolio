...
const Counter = () => {
  return (
    <div><div className="section-counter paralax-mf bg-image" style={{backgroundImage: 'url(assets/img/counters-bg.jpg)'}}>
      ...
      <div className="row">
        <div className="col-sm-3 col-lg-3">
          <div className="counter-box counter-box pt-4 pt-md-0">
            ...
            <div className="counter-num">
              <p ci data-purecounter-start={0} data-purecounter-end={450} data-purecounter-duration={1} className="counter purecounter" />
        ...
        <div className="col-sm-3 col-lg-3">
          <div className="counter-box pt-4 pt-md-0">
            ...
            <div className="counter-num">
              <p  CountUp end={100}  className="counter purecounter" />
